class CarsController < ApplicationController
  ...
  private
    ...
    def car_params
      params.require(:car).permit(:registration_no, :mileage, :last_oil_change, :per_day_rent, :user_id,:make_id,:car_model_id,:details,car_photos_attributes: [:id,:image,:image_type,:comments])
    end
end
